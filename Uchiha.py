...
cl = LineClient(authToken='EwcH1P3i2nBPxmxJTaS0.HCVSuTnnBezIm5W0qjCQ4a.s6Z2eVWzzIcBJ5eknZCk69k99b0z1QdP18nb9452XFQ=')
...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["u85cbec52d34d6c4662339c3440972ae0"]
owner = ["u85cbec52d34d6c4662339c3440972ae0"]
admin = ["u85cbec52d34d6c4662339c3440972ae0"]
staff = ["u85cbec52d34d6c4662339c3440972ae0",""]
...
wait = {
    ...
    "unsend": False,
    "mention":"NGINTIP",
    "Respontag":"TAG TAG AWAS KENA CIPOK",
    "welcome":"Selamat Datang dan Semoga Betah",
    "comment":"Like like & like by DAN ZENJU",
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"Creator DAN ZENJU") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if msg._from in admin:
                            try:
                                ...
                                cl.sendMessage(msg.to, "┃🌌┃ ┃ZENJU┃ Family Grup Info\n\n┃🌌┃ Nama Group : {}".format(G.name)+ "\n┃🌌┃ ID Group : {}".format(G.id)+ "\n┃🌌┃ Pembuat : {}".format(G.creator.displayName)+ "\n┃🌌┃ Waktu Dibuat : {}".format(str(timeCreated))+ "\n┃🌌┃ Jumlah Member : {}".format(str(len(G.members)))+ "\n┃🌌┃ Jumlah Pending : {}".format(gPending)+ "\n┃🌌┃ Group Qr : {}".format(gQr)+ "\n┃🌌┃ Group Ticket : {}".format(gTicket))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"┃❄┃ ┃ZENJU┃ Family bot\n\n"+ma+"\nTotal「%s」Family Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "┃⚠┃ ┃ZENJU┃ Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))

                        elif cmd == "speed" or cmd == "sp":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               start = time.time()
                               cl.sendMessage(msg.to, "Please Wait Yah Bebz... \n█▒▒▒▒▒▒▒▒▒ 10% \n██▒▒▒▒▒▒▒▒ 30% \n████▒▒▒▒▒▒ 40% \n████████▒▒ 80% \n██████████ 100% \nKecepatan max 100% Ampuh 😏")
                               elapsed_time = time.time() - start
                               cl.sendMessage(msg.to, "Nih Hasilnya Sayang... \n{} detik".format(str(elapsed_time)))
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = True
                                cl.sendText(msg.to,"unsendMessage diaktifkan")

                        elif cmd == "unsend off" or text.lower() == 'unsend off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["unsend"] = False
                                cl.sendText(msg.to,"unsendMessage dinonaktifkan")       
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"┃🔐┃ ┃ZENJU┃ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
